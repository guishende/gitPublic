...
""" 系统首页，在slide 图片 """
@register.inclusion_tag('company/widget/announce_widget.html', name='display_index_announce_widget')
...
@register.inclusion_tag('company/widget/products_widget.html', name='display_products_widget')
...
@register.inclusion_tag('company/widget/news_widget.html', name='display_index_news_widget')
...
@register.inclusion_tag('company/widget/category_widget.html', name='display_faq_category_widget')
...
@register.inclusion_tag('company/widget/category_widget.html', name='display_product_category_widget')
...
@register.inclusion_tag('company/widget/category_widget.html', name='display_service_category_widget')
...
@register.inclusion_tag('company/widget/category_widget.html', name='display_about_category_widget')
...
@register.inclusion_tag('company/widget/category_widget.html', name='display_download_category_widget')
...
@register.inclusion_tag('company/widget/index_faqs_widget.html', name='display_index_recent_faqs')
