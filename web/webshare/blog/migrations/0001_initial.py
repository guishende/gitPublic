# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-11-26 10:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('click_count', models.IntegerField(blank=True, default=0, verbose_name='\u70b9\u51fb\u6b21\u6570')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='userTag_set', to=settings.AUTH_USER_MODEL, verbose_name='\u7528\u6237')),
            ],
            options={
                'db_table': 'blog_tag',
                'verbose_name': '\u6807\u7b7e',
        ...
        migrations.AddField(
            model_name='article',
            name='tag',
            field=models.ManyToManyField(related_name='tagArticle_set', to='blog.Tag', verbose_name='\u6807\u7b7e'),
        ),
        migrations.AddField(
            model_name='article',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userArticle_set', to=settings.AUTH_USER_MODEL, verbose_name='\u7528\u6237'),
        ),
    ]
